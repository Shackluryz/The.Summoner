...
public class UIController : MonoBehaviour
{
    ...
    //Esse método é executado quando clicamos no botão do Nickname para entrar no Lobby
    public void OnClick_NickName()
    {
        ...
        gameController.StartConnection(txtNickname.text);//gameController.StartConnection(txtNickname.text, listRegion.value);
    }
    /*
